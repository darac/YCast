...
In case you are using (or plan on using) Nginx to proxy requests, have a look at
...
The current filters/limits can be queried through a REST API by calling the GET method
